...
def generate_random_event() -> dict:
    ...
    return_value = {
        ...
        "attribute_rule.name": 
        "attribute_rule.modelkey": [gen_model_key(random.choice([7,8,603,612,663,917,5200]))],
        "attribute_firewallmanager.name":
        "attribute_firewallmanager.modelkey": [gen_model_key(random.choice([7,8,612]))],
        ...
        "dstDnsInfo.hostName":
        "dstDnsInfo.source":
        "reporterEntity.collectorId":
        "reporterEntity_reporter.name":
        "reporterEntity_reporter.modelkey": [gen_model_key(random.choice([7,8,603,612,663,917,5200]))],
        "SchemaVersion":
        "lastActivity":
        "activity":
        "srck8Info.k8scollectorId":
        "srck8Info_k8sservice.name":
        "srck8Info_k8sservice.modelkey": [gen_model_key(1504)],
        "srck8Info_k8scluster.name":
        "srck8Info_k8scluster.modelkey": [gen_model_key(1501)],
        "srck8Info_k8snamespace.name":
        "srck8Info_k8snamespace.modelkey": [gen_model_key(1503)],
        "srck8Info_k8snode.name":
        "srck8Info_k8snode.modelkey": [gen_model_key(1502)],
        "dstk8Info.k8scollectorId":
        "dstk8Info_k8sservice.name":
        "dstk8Info_k8sservice.modelkey": [gen_model_key(1504)],
        "dstk8Info_k8scluster.name":
        "dstk8Info_k8scluster.modelkey": [gen_model_key(1501)],
        "dstk8Info_k8snamespace.name":
        "dstk8Info_k8snamespace.modelkey": [gen_model_key(1503)],
        "dstk8Info_k8snode.name":
        "dstk8Info_k8snode.modelkey": [gen_model_key(1502)],
        "lbflowtype":
        ...
        "srcIpEntity.name":
        "srcIpEntity.modelkey": [gen_model_key(541)],
        "dstIpEntity.name":
        "dstIpEntity.modelkey": [gen_model_key(541)],
        "srcNic.name":
        "srcNic.modelkey": [gen_model_key(random.choice([18,17,16]))],
        "dstNic.name":
        "dstNic.modelkey": [gen_model_key(random.choice([18,17,16]))],
        "srcVm.name":
        "srcVm.modelkey": [gen_model_key(1601)],
        "dstVm.name":
        "dstVm.modelkey": [gen_model_key(1601)],
        "srcSg.name":
        "srcSg.modelkey": [gen_model_key(random.choice([550,213,602,958]))],
        "dstSg.name":
        "dstSg.modelkey": [gen_model_key(random.choice([550,213,602,958]))],
        "srcIpSet.name":
        "srcIpSet.modelkey": [gen_model_key(random.choice([84,214]))]
        "dstIpSet.name":
        "dstIpSet.modelkey": [gen_model_key(random.choice([84,214]))]
        "srcSt.name":
        "srcSt.modelkey":
        "dstSt.name":
        "dstSt.modelkey":
        ...
        "dstHost.modelkey":
        "srcManagers.name":
        "srcManagers.modelkey":
        "dstManagers.name":
        "dstManagers.modelkey":
        "flowDomain.name":
        "flowDomain.modelkey":
        "srcLookupDomain.name":
        "srcLookupDomain.modelkey":
        "dstLookupDomain.name":
        "dstLookupDomain.modelkey":
        "srcVpc.name":
        "srcVpc.modelkey":
        "dstVpc.name":
        "dstVpc.modelkey":
        "srcTransportNode.name":
        "srcTransportNode.modelkey":
        "dstTransportNode.name":
        "dstTransportNode.modelkey":
        "srcDvpg.name":
        "srcDvpg.modelkey":
        "dstDvpg.name":
        "dstDvpg.modelkey":
