...
csvDataFile = 'IP_VM_MetaData_with_all_possible_ports_with_ip_as_int.csv'
listofip = []
...
csv_file = '4Tuple_with_diff_ports_ip_as_int.csv'
...
def fetch_data(i,j):
    ...
    port_name_protocol = random.choice(data[j][1])
...
if __name__ == '__main__':
    for i in range(12500):
        for j in range(12500,16500):
            write_to_csv([fetch_data(i,j)])
