...
(
    ...
    `attribute_rule.__searchTags` Array(Array(String)), 
    `attribute_rule.__related_entities` Array(Array(String)), 
    `attribute_firewallmanager.name` Array(String), 
    `attribute_firewallmanager.modelkey` Array(String), 
    `attribute_firewallmanager.__searchTags` Array(Array(String)), 
    `attribute_firewallmanager.__related_entities` Array(Array(String)), 
    ...
    `reporterEntity_reporter.__searchTags` Array(Array(String)), 
    `reporterEntity_reporter.__related_entities` Array(Array(String)), 
    ...
    `srck8Info_k8sservice.__searchTags` Array(Array(String)), 
    `srck8Info_k8sservice.__related_entities` Array(Array(String)), 
    `srck8Info_k8scluster.name` Array(String), 
    `srck8Info_k8scluster.modelkey` Array(String), 
    `srck8Info_k8scluster.__searchTags` Array(Array(String)), 
    `srck8Info_k8scluster.__related_entities` Array(Array(String)), 
    `srck8Info_k8snamespace.name` Array(String), 
    `srck8Info_k8snamespace.modelkey` Array(String), 
    `srck8Info_k8snamespace.__searchTags` Array(Array(String)), 
    `srck8Info_k8snamespace.__related_entities` Array(Array(String)), 
    `srck8Info_k8snode.name` Array(String), 
    `srck8Info_k8snode.modelkey` Array(String), 
    `srck8Info_k8snode.__searchTags` Array(Array(String)), 
    `srck8Info_k8snode.__related_entities` Array(Array(String)), 
    `dstk8Info.k8scollectorId` Array(UInt32), 
    `dstk8Info_k8sservice.name` Array(String), 
    `dstk8Info_k8sservice.modelkey` Array(String), 
    `dstk8Info_k8sservice.__searchTags` Array(Array(String)), 
    `dstk8Info_k8sservice.__related_entities` Array(Array(String)), 
    `dstk8Info_k8scluster.name` Array(String), 
    `dstk8Info_k8scluster.modelkey` Array(String), 
    `dstk8Info_k8scluster.__searchTags` Array(Array(String)), 
    `dstk8Info_k8scluster.__related_entities` Array(Array(String)), 
    `dstk8Info_k8snamespace.name` Array(String), 
    `dstk8Info_k8snamespace.modelkey` Array(String), 
    `dstk8Info_k8snamespace.__searchTags` Array(Array(String)), 
    `dstk8Info_k8snamespace.__related_entities` Array(Array(String)), 
    `dstk8Info_k8snode.name` Array(String), 
    `dstk8Info_k8snode.modelkey` Array(String), 
    `dstk8Info_k8snode.__searchTags` Array(Array(String)), 
    `dstk8Info_k8snode.__related_entities` Array(Array(String)), 
    ...
    `srcIpEntity.__searchTags` Array(Array(String)), 
    `srcIpEntity.__related_entities` Array(Array(String)), 
    `dstIpEntity.name` Array(String), 
    `dstIpEntity.modelkey` Array(String), 
    `dstIpEntity.__searchTags` Array(Array(String)), 
    `dstIpEntity.__related_entities` Array(Array(String)), 
    `srcNic.name` Array(String), 
    `srcNic.modelkey` Array(String), 
    `srcNic.__searchTags` Array(Array(String)), 
    `srcNic.__related_entities` Array(Array(String)), 
    `dstNic.name` Array(String), 
    `dstNic.modelkey` Array(String), 
    `dstNic.__searchTags` Array(Array(String)), 
    `dstNic.__related_entities` Array(Array(String)), 
    `srcVm.name` Array(String), 
    `srcVm.modelkey` Array(String), 
    `srcVm.__searchTags` Array(Array(String)), 
    `srcVm.__related_entities` Array(Array(String)), 
    `dstVm.name` Array(String), 
    `dstVm.modelkey` Array(String), 
    `dstVm.__searchTags` Array(Array(String)), 
    `dstVm.__related_entities` Array(Array(String)), 
    `srcSg.name` Array(String), 
    `srcSg.modelkey` Array(String), 
    `srcSg.__searchTags` Array(Array(String)), 
    `srcSg.__related_entities` Array(Array(String)), 
    `dstSg.name` Array(String), 
    `dstSg.modelkey` Array(String), 
    `dstSg.__searchTags` Array(Array(String)), 
    `dstSg.__related_entities` Array(Array(String)), 
    `srcIpSet.name` Array(String), 
    `srcIpSet.modelkey` Array(String), 
    `srcIpSet.__searchTags` Array(Array(String)), 
    `srcIpSet.__related_entities` Array(Array(String)), 
    `dstIpSet.name` Array(String), 
    `dstIpSet.modelkey` Array(String), 
    `dstIpSet.__searchTags` Array(Array(String)), 
    `dstIpSet.__related_entities` Array(Array(String)), 
    `srcSt.name` Array(String), 
    `srcSt.modelkey` Array(String), 
    `srcSt.__searchTags` Array(Array(String)), 
    `srcSt.__related_entities` Array(Array(String)), 
    `dstSt.name` Array(String), 
    `dstSt.modelkey` Array(String), 
    `dstSt.__searchTags` Array(Array(String)), 
    `dstSt.__related_entities` Array(Array(String)), 
    `srcL2Net.name` Array(String), 
    `srcL2Net.modelkey` Array(String), 
    `srcL2Net.__searchTags` Array(Array(String)), 
    `srcL2Net.__related_entities` Array(Array(String)), 
    `dstL2Net.name` Array(String), 
    `dstL2Net.modelkey` Array(String), 
    `dstL2Net.__searchTags` Array(Array(String)), 
    `dstL2Net.__related_entities` Array(Array(String)), 
    `srcGroup.name` Array(String), 
    `srcGroup.modelkey` Array(String), 
    `srcGroup.__searchTags` Array(Array(String)), 
    `srcGroup.__related_entities` Array(Array(String)), 
    `dstGroup.name` Array(String), 
    `dstGroup.modelkey` Array(String), 
    `dstGroup.__searchTags` Array(Array(String)), 
    `dstGroup.__related_entities` Array(Array(String)), 
    `srcCluster.name` Array(String), 
    `srcCluster.modelkey` Array(String), 
    `srcCluster.__searchTags` Array(Array(String)), 
    `srcCluster.__related_entities` Array(Array(String)), 
    `dstCluster.name` Array(String), 
    `dstCluster.modelkey` Array(String), 
    `dstCluster.__searchTags` Array(Array(String)), 
    `dstCluster.__related_entities` Array(Array(String)), 
    `srcRp.name` Array(String), 
    `srcRp.modelkey` Array(String), 
    `srcRp.__searchTags` Array(Array(String)), 
    `srcRp.__related_entities` Array(Array(String)), 
    `dstRp.name` Array(String), 
    `dstRp.modelkey` Array(String), 
    `dstRp.__searchTags` Array(Array(String)), 
    `dstRp.__related_entities` Array(Array(String)), 
    `srcDc.name` Array(String), 
    `srcDc.modelkey` Array(String), 
    `srcDc.__searchTags` Array(Array(String)), 
    `srcDc.__related_entities` Array(Array(String)), 
    `dstDc.name` Array(String), 
    `dstDc.modelkey` Array(String), 
    `dstDc.__searchTags` Array(Array(String)), 
    `dstDc.__related_entities` Array(Array(String)), 
    `srcHost.name` Array(String), 
    `srcHost.modelkey` Array(String), 
    `srcHost.__searchTags` Array(Array(String)), 
    `srcHost.__related_entities` Array(Array(String)), 
    `dstHost.name` Array(String), 
    `dstHost.modelkey` Array(String), 
    `dstHost.__searchTags` Array(Array(String)), 
    `dstHost.__related_entities` Array(Array(String)), 
    `srcManagers.name` Array(String), 
    `srcManagers.modelkey` Array(String), 
    `srcManagers.__searchTags` Array(Array(String)), 
    `srcManagers.__related_entities` Array(Array(String)), 
    `dstManagers.name` Array(String), 
    `dstManagers.modelkey` Array(String), 
    `dstManagers.__searchTags` Array(Array(String)), 
    `dstManagers.__related_entities` Array(Array(String)), 
    `flowDomain.name` Array(String), 
    `flowDomain.modelkey` Array(String), 
    `flowDomain.__searchTags` Array(Array(String)), 
    `flowDomain.__related_entities` Array(Array(String)), 
    `srcLookupDomain.name` Array(String), 
    `srcLookupDomain.modelkey` Array(String), 
    `srcLookupDomain.__searchTags` Array(Array(String)), 
    `srcLookupDomain.__related_entities` Array(Array(String)), 
    `dstLookupDomain.name` Array(String), 
    `dstLookupDomain.modelkey` Array(String), 
    `dstLookupDomain.__searchTags` Array(Array(String)), 
    `dstLookupDomain.__related_entities` Array(Array(String)), 
    `srcVpc.name` Array(String), 
    `srcVpc.modelkey` Array(String), 
    `srcVpc.__searchTags` Array(Array(String)), 
    `srcVpc.__related_entities` Array(Array(String)), 
    `dstVpc.name` Array(String), 
    `dstVpc.modelkey` Array(String), 
    `dstVpc.__searchTags` Array(Array(String)), 
    `dstVpc.__related_entities` Array(Array(String)), 
    `srcTransportNode.name` Array(String), 
    `srcTransportNode.modelkey` Array(String), 
    `srcTransportNode.__searchTags` Array(Array(String)), 
    `srcTransportNode.__related_entities` Array(Array(String)), 
    `dstTransportNode.name` Array(String), 
    `dstTransportNode.modelkey` Array(String), 
    `dstTransportNode.__searchTags` Array(Array(String)), 
    `dstTransportNode.__related_entities` Array(Array(String)), 
    `srcDvpg.name` Array(String), 
    `srcDvpg.modelkey` Array(String), 
    `srcDvpg.__searchTags` Array(Array(String)), 
    `srcDvpg.__related_entities` Array(Array(String)), 
    `dstDvpg.name` Array(String), 
    `dstDvpg.modelkey` Array(String), 
    `dstDvpg.__searchTags` Array(Array(String)), 
    `dstDvpg.__related_entities` Array(Array(String)), 
    `srcDvs.name` Array(String), 
    `srcDvs.modelkey` Array(String), 
    `srcDvs.__searchTags` Array(Array(String)), 
    `srcDvs.__related_entities` Array(Array(String)), 
    `dstDvs.name` Array(String), 
    `dstDvs.modelkey` Array(String), 
    `dstDvs.__searchTags` Array(Array(String)), 
    `dstDvs.__related_entities` Array(Array(String))
)
ENGINE = MergeTree()
ORDER BY name
